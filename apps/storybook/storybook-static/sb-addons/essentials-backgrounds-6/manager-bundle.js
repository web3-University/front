try {
  (() => {
              ...
              function (r, i, d) {
                ...
                function n(a) {
                  ...
                  for (
                    ...
                    m >= 0 &&
                    ((s = a[m]), (y = s.cacheItem.get(s.arg)), !y || !y.size);
                    m--
                  )
    ...
    f();
    h();
    var Nc = __STORYBOOK_CLIENT_LOGGER__,
      {
        deprecate: Hc,
        logger: K,
        once: qc,
...
`)),
    ...
    var ne = "storybook/background",
      ...
      te = (0, Y.default)(1e3)((e, o, c, r, i, d) => ({
        ...
        value: c,
        right: r ? g.createElement(fe, { background: c }) : void 0,
        active: d,
      })),
      ...
      ye = w(function () {
        let e = P(S, be),
          ...
          [r, i] = L(),
          d = r[S]?.value,
          l = j(() => he(d, e.values, e.default), [e, d]);
        Array.isArray(e) &&
          K.warn(
