  ...
  (() => {
      ...
      On = ce(() => {
        ...
        (id = __STORYBOOK_ICONS__),
          ({
            ...
            BoldIcon: Md,
            BookIcon: jd,
            BookmarkHollowIcon: Dd,
            BookmarkIcon: Fd,
            BottomBarIcon: Bd,
            BottomBarToggleIcon: Ud,
            BoxIcon: Wd,
            BranchIcon: Hd,
            BrowserIcon: zd,
            ButtonIcon: Gd,
    ...
    function _o(e, t = {}) {
      ...
      function N(m, g) {
        let O = h(),
          B = b(a, O),
          C = (te, Ne) => m.style.setProperty(te, Ne + "");
        C("--xlp", Dt(bt(Dn(g, 90) - 180), 0, 180, -u / 2, u / 2) + "px"),
          C("--dc", r - rt(1e3 * be()) + "ms");
        let V = be() < Po ? Ue(be() * xo, 2) : 0;
        C("--x1", V),
          C("--x2", -1 * V),
          C("--x3", V),
          C("--x4", Ue(bt(Dt(bt(Dn(g, 90) - 180), 0, 180, -1, 1)), 4)),
          C("--y1", Ue(be() * Mn, 4)),
          C("--y2", Ue(be() * o * (Or() ? 1 : -1), 4)),
          C("--y3", Mn),
          C("--y4", Ue(Ao(Dt(bt(g - 180), 0, 180, o, -o), 0), 4)),
          C("--w", (B ? s : rt(4 * be()) + s / 2) + "px"),
          C("--h", (B ? s : rt(2 * be()) + s) + "px");
        let H = O.toString(2).padStart(3, "0").split("");
        C("--hr", H.map((te) => +te / 2 + "").join(" ")),
          C("--r", H.join(" ")),
          C("--rd", Ue(be() * (Co - Ln) + Ln) + "ms"),
          C("--br", B ? "50%" : 0);
      }
      let v;
      function T() {
        (e.innerHTML = ""),
          ...
          (f = (function (m, g = [], O) {
            let B = [];
            for (let { color: C } of g) {
              let V = Mt("div");
              (V.className = `${wn} ${O}`), V.style.setProperty("--bgc", C);
              let H = Mt("div");
      ...
      return (
        ...
        {
          update(m) {
            let g = m.particleCount ?? _n,
              O = m.particleShape ?? Cn,
              B = m.particleSize ?? Pn,
              C = m.particleClass ?? xn,
              V = m.colors ?? Tn,
              H = m.stageHeight ?? Nn,
              te = m.duration ?? In,
              Ne = m.force ?? Rn,
            ...
            if (g === i) {
              ...
              for (let [Ke, { color: Te }] of Fn(d)) {
                ...
                JSON.stringify(n) !== JSON.stringify(V) &&
                  ...
                  C !== c &&
                    (c && Ie.classList.remove(c), C && Ie.classList.add(C));
              }
            } else Be = !0;
            l && !ke && clearTimeout(v),
    ...
    function oe(e, t) {
      ...
      if (e && Hn(e) && t && Hn(t)) {
        ...
        if (Array.isArray(e) && Array.isArray(t)) return Uo(e, t);
        if (e instanceof Map && t instanceof Map) return Ho(e, t);
        if (e instanceof Set && t instanceof Set) return zo(e, t);
        if (ArrayBuffer.isView(e) && ArrayBuffer.isView(t)) return Wo(e, t);
        if (Wn(e) && Wn(t)) return e.source === t.source && e.flags === t.flags;
    ...
    function Gn(e, t, n) {
      ...
      if (!_.nullOrUndefined(i)) {
        if (_.defined(c)) {
          if (_.array(c) || _.plainObject(c)) return Jo(c, l, i);
        } else return oe(l, i);
        return !1;
      }
    ...
    function qn(e) {
      return ([t, n]) =>
        _.array(e)
          ? oe(e, n) || e.some((r) => oe(r, n) || (_.array(n) && Vt(n)(r)))
          : _.plainObject(e) && e[t]
            ? !!e[t] && oe(e[t], n)
            : oe(e, n);
    }
    ...
    function $n(e) {
      return (t) =>
        _.array(e)
          ? e.some((n) => oe(n, t) || (_.array(t) && Vt(t)(n)))
          : oe(e, t);
    }
    function Qe(e, t) {
    ...
    function Wt(e) {
      return e.parentNode !== null ? Wt(e.parentNode) : e;
    }
    function wt(e, t) {
      ...
      var s = Wt(e);
      return s.host ? wt(s.host, t) : wt(e, Wt(t).host);
    }
    function ze(e) {
      var t =
    ...
    function Ht(e) {
      ...
      var o = {
        ...
        i = e.nodeName === "HTML" ? Cr(e.ownerDocument) : {},
    ...
    function wi(e, t) {
      ...
      return (
        ...
        (e.arrowElement = r),
        (e.offsets.arrow =
          ((n = {}), Ge(n, u, Math.round(m)), Ge(n, d, ""), n)),
        e
      );
    }
    function Ti(e) {
      ...
      let h = {
        ...
        b = {
          ...
          beaconOuter: {
            ...
            backgroundColor: `rgba(${Ca(u.primaryColor).join(",")}, 0.2)`,
    ...
    function Va(e) {
      let {
        ...
        { back: g, close: O, last: B, next: C, skip: V } = b,
        H = { primary: O };
      return (
        r &&
          ((H.primary = i ? B : C),
        ...
        q(
          ...
          q(
            ...
            m && q("h1", { "aria-label": Ce(m), style: T.tooltipTitle }, m),
    ...
    function ws({ api: e }) {
      let [t, n] = ue(!0),
        ...
        N = Je(() => {
          let C = new URL(window.location.href),
            V = decodeURIComponent(C.searchParams.get("path"));
          (C.search = `?path=${V}&onboarding=false`),
            history.replaceState({}, "", C.href),
            e.setQueryParams({ onboarding: "false" }),
            n(!1);
        }, [e, n]),
        v = Je(() => {
          e.emit(Un, { step: "6:FinishedOnboarding", type: "telemetry" }),
      ...
      if (
        ...
        ae(() => {
          a((C) =>
            ["1:Intro", "5:StoryCreated", "6:FinishedOnboarding"].includes(C)
              ? C
              : u
                ? "4:CreateStory"
                : l
        ...
        ae(() => e.emit(Un, { step: i, type: "telemetry" }), [e, i]),
        !t)
      )
        return null;
            ...
            "../../node_modules/prop-types/factoryWithTypeCheckers.js"(e, t) {
              ...
              t.exports = function (l, p) {
                ...
                function H(E) {
                  ...
                  function x(U, D, L, z, M) {
                    for (var F = U[D], G = 0; G < E.length; G++)
                      if (N(F, E[G])) return null;
...
Valid keys: ` +
        ...
        (Ln = 200),
          ...
          (Ue = (e, t = 2) => rt((e + Number.EPSILON) * 10 ** t) / 10 ** t),
        ...
        R.asyncGeneratorFunction = function (e) {
          return Ct(e) === "AsyncGeneratorFunction";
        };
        ...
        (Wi = Wr("function")),
          ...
          (tr = function (e) {
            return !zi(e) && !Hi(e) && (Wi(e) || typeof e == "object");
          }),
          (zi = Wr("undefined")),
          (Yt = function (e) {
            ...
            ct(n, [
              {
                ...
                get: function () {
                  ...
                  return (
                    ...
                    [W.OPENING, W.OPEN].indexOf(c) !== -1 &&
                      (v = J(J({}, v), h)),
                    c === W.CLOSING && (v = J(J({}, v), f)),
                    c === W.OPEN && !o && (v = J(J({}, v), b)),
                    a === "center" && (v = J(J({}, v), d)),
                    i && (v = J(J({}, v), N)),
                    J(J({}, u), v)
                  );
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return (
                    ...
                    c === W.OPEN && p.push("__floater__open"),
              ...
              return (
                ...
                re(we(o), "handleTransitionEnd", function () {
                  ...
                  o.wrapperPopper && o.wrapperPopper.instance.update(),
                    o.setState(
                      { status: i === W.OPENING ? W.OPEN : W.IDLE },
                      function () {
                        var s = o.state.status;
                        a(s === W.OPEN ? "open" : "close", o.props);
                      },
                    );
                }),
                    ...
                    (o.event === "click" || (o.event === "hover" && l)) &&
                      (St({
                        ...
                        data: [
                          {
                            event: a,
                            status: p === W.OPEN ? "closing" : "opening",
                          },
                        ],
                        debug: o.debug,
                      }),
              ...
              ct(n, [
                ...
                },
                {
                  ...
                  value: function (r, o) {
                    if (ve()) {
                      ...
                      if (r.open !== s) {
                        var f;
                        A.boolean(s) && (f = s ? W.OPENING : W.CLOSING),
                          this.toggle(f);
                      }
                      (r.wrapperOptions.position !== l.position ||
                        ...
                        this.floaterRef &&
                          (d("status", W.OPENING) || d("status", W.CLOSING)) &&
                          pa(
                            this.floaterRef,
                            "transitionend",
                    ...
                    if (i) {
                      ...
                      new Zn(this.target, this.wrapperRef, {
                        ...
                        onCreate: function (g) {
                          (r.wrapperPopper = g),
                            r._isMounted &&
                              r.setState({ statusWrapper: W.IDLE }),
                            c(g, "wrapper"),
                            u !== g.placement &&
                              setTimeout(function () {
                                g.instance.update();
                ...
                },
                {
                  ...
                  value: function (r) {
                    var o = this.state.status,
                      i = o === W.OPEN ? W.CLOSING : W.OPENING;
                ...
                },
                {
                  ...
                  get: function () {
                    ...
                    if (a) {
                      var p;
                      [W.IDLE].indexOf(i) === -1 || [W.IDLE].indexOf(s) === -1
                        ? (p = l.wrapperPosition)
        ...
        (Wa = Ua),
          (Ha = class extends Le {
            ...
            render() {
              ...
              if (r()) return null;
              let a = n !== "center" && e && q(Wa, { styles: i });
              if (Qr() === "safari") {
      ...
      `),
            ...
            render() {
              let {
                ...
                l = _.string(o.open) ? o.open : (0, ga.default)(o.open),
                p = {
                  "aria-label": l,
                  onClick: i,
                  onMouseEnter: i,
        ...
        (Ka = Va),
            ...
            componentDidUpdate(e) {
              ...
              h("lifecycle", k.INIT, k.READY) &&
                ...
                f("lifecycle", k.TOOLTIP) &&
                  ...
                  this.tooltip &&
                    ((this.scope = new Ga(this.tooltip, {
          ...
          (ro = class extends Le {
            constructor(e) {
              super(e),
                ...
                P(this, "handleClickOverlay", () => {
                  let { index: a } = this.state,
                    { steps: s } = this.props;
                  We(this.props, s[a]).disableOverlayClose ||
              ...
              (this.store = Ba({ ...e, controlled: r && _.number(o) })),
            ...
            componentDidUpdate(e, t) {
              ...
              if (
                ...
                let te = _.number(u) && u < l ? $.NEXT : $.PREV;
                n === $.STOP && (te = $.START),
                  [j.FINISHED, j.SKIPPED].includes(a) ||
                    v({
              ...
              if (
                ...
                let te = We(this.props, p[t.index]);
                this.callback({
                  ...H,
                  index: t.index,
                  lifecycle: k.COMPLETE,
