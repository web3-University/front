try {
  (() => {
    ...
    var Ba = __STORYBOOK_CORE_EVENTS__,
      {
        ...
        TESTING_MODULE_CANCEL_TEST_RUN_RESPONSE: Fo,
        TESTING_MODULE_CRASH_REPORT: Bo,
        TESTING_MODULE_PROGRESS_REPORT: Uo,
        TESTING_MODULE_RUN_ALL_REQUEST: Ho,
      ...
      if (e && t && (r = e.constructor) === t.constructor) {
        ...
        if (r === Set) {
          ...
          for (n of e)
            if (
              ((a = n),
              (a && typeof a == "object" && ((a = Be(t, a)), !a)) || !t.has(a))
            )
              return !1;
          return !0;
        }
    ...
    function I(e) {
      ...
      var f = _t.exec(t.substring(0, 50));
      if (f) {
    ...
    function At(e, t, r, n) {
      if (
        ...
        return n >= 1 ? V(e, t, r) : "rgba(" + B(e, t, r) + "," + n + ")";
      if (typeof e == "object" && t === void 0 && r === void 0 && n === void 0)
        return e.alpha >= 1
          ? V(e.hue, e.saturation, e.lightness)
          : "rgba(" + B(e.hue, e.saturation, e.lightness) + "," + e.alpha + ")";
      throw new T(2);
    }
    function oe(e, t, r) {
      if (typeof e == "number" && typeof t == "number" && typeof r == "number")
    ...
    var Er = ({ rows: e, columns: t, rowsData: r }) => {
      ...
      Pr = F.div({ flex: 1, padding: "0 0 0 5px" }),
    ...
    var Fr = F(lt)({ margin: 0, padding: "10px 5px 20px" }),
      Br = Ue(({ theme: e, ...t }) =>
        o.createElement(Ir, {
