try {
  (() => {
                  ...
                  return function (u) {
                    var d = function () {
                      var h = p,
                        ...
                        R = !0,
                        _;
                      if ((d.numArgs || d.numArgs === 0) && d.numArgs !== v + 1)
                        throw new Error(
                          "Memoizerific functions should always be called with the same number of arguments",
                        );
                      for (_ = 0; _ < v; _++) {
                        if (
                          ((U[_] = { cacheItem: h, arg: arguments[_] }),
                          h.has(arguments[_]))
                        ) {
                          h = h.get(arguments[_]);
                          continue;
                      ...
                      return (
                        ...
                        R ||
                          ...
                          h.set(arguments[v], T)),
                        n > 0 &&
                          ((U[v] = { cacheItem: h, arg: arguments[v] }),
                          R ? o(r, U) : r.push(U),
    ...
    var Tt = __STORYBOOK_API__,
      {
        ...
        experimental_UniversalStore: Ft,
    ...
    var $ = ve(ce()),
      ...
      De = S.div({ display: "inline-flex", alignItems: "center" }),
      ue = S.div(({ theme: e }) => ({
        display: "inline-block",
        textDecoration: "none",
        padding: 10,
      ...
      Fe = S(L)(() => ({ display: "inline-flex", alignItems: "center" })),
      Ne = S.div(({ theme: e }) => ({
        fontSize: e.typography.size.s2 - 1,
        marginLeft: 10,
      })),
      ...
      He = Q(function () {
        ...
        let n =
            ...
            V,
          p = ee(),
          r = ze(p.current, n.styles, e.viewportRotated);
        return (
          O(() => {
            p.current = r;
          }, [n]),
            ...
            : c.createElement(
                ...
                c.createElement(
                  W,
                  {
                    placement: "top",
                    tooltip: ({ onHide: u }) =>
                      c.createElement(q, { links: Me(I, n, t, u) }),
                    closeOnOutsideClick: !0,
                    onVisibleChange: m,
                  },
                  c.createElement(
    ...
    z.register(B, (e) => {
      z.add(B, {
        ...
        render: () =>
          FEATURES?.viewportStoryGlobals ? F(Le, { api: e }) : F(He, null),
      });
    });
  })();
} catch (e) {
