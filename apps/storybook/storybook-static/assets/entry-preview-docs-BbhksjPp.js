...
import { r as Ge, R as ft } from "./index-D4lIrffr.js";
  ...
  Ii = K({
    "../../node_modules/estraverse/estraverse.js"(e) {
      (function t(r) {
        ...
        function E(x, y) {
          return (
            (x === n.ObjectExpression || x === n.ObjectPattern) &&
            y === "properties"
          );
        }
        function w(x, y) {
          for (var v = x.length - 1; v >= 0; --v)
            if (x[v].node === y) return !0;
          return !1;
        }
        (C.prototype.traverse = function (x, y) {
          ...
          for (
            ...
            if (P.node) {
              if (
                ((V = this.__execute(y.enter, P)),
                this.__state === u || V === u)
              )
                return;
              if ((v.push(Z), B.push(P), this.__state === h || V === h))
                continue;
              if (
                ((j = P.node),
                (M = j.type || P.wrap),
                ...
                if (((U = se[H]), (ue = j[U]), !!ue)) {
                  if (Array.isArray(ue)) {
                    for (ne = ue.length; (ne -= 1) >= 0; )
                      if (ue[ne] && !w(B, ue[ne])) {
                        if (E(M, se[H]))
                          P = new A(ue[ne], [U, ne], "Property", null);
                        else if (D(ue[ne]))
                          P = new A(ue[ne], [U, ne], null, null);
                        else continue;
                        v.push(P);
                      }
                  } else if (D(ue)) {
                  ...
                  if (((we = ne[U]), (se = P[we]), !!se))
                    if (Array.isArray(se)) {
                      for (H = se.length; (H -= 1) >= 0; )
                        if (se[H]) {
                          if (E(j, ne[U]))
                            V = new A(se[H], [we, H], "Property", new F(se, H));
                          else if (D(se[H]))
                            V = new A(se[H], [we, H], null, new F(se, H));
                          else continue;
                          v.push(V);
                        }
            ...
            b(x, {
              enter: function (U) {
                for (
                  var H;
                  V < B.length &&
                  ((H = B[V]), !(H.extendedRange[1] > U.range[0]));
                )
            ...
            b(x, {
              leave: function (U) {
                for (
                  var H;
                  V < B.length &&
                  ((H = B[V]), !(U.range[1] < H.extendedRange[0]));
                )
  ...
  At = K({
    "../../node_modules/escodegen/node_modules/source-map/lib/util.js"(e) {
      ...
      function s(_) {
        var x = _.match(r);
        return x
          ? { scheme: x[1], auth: x[2], host: x[3], port: x[4], path: x[5] }
          : null;
      }
      e.urlParse = s;
      function o(_) {
      ...
      function n(s, o, u, h) {
        if (u < h) {
          var p = r(u, h),
            m = u - 1;
          t(s, p, h);
          for (var g = s[h], F = u; F < h; F++)
            o(s[F], g) <= 0 && ((m += 1), t(s, m, F));
          t(s, m + 1, F);
          var A = m + 1;
          ...
          if (D >= 0) {
            ...
            if (g.column === void 0)
              ...
              for (
                ...
                E && E.originalLine === F && E.originalColumn == b;
              )
                C.push({
                  line: t.getArg(E, "generatedLine", null),
                  column: t.getArg(E, "generatedColumn", null),
      ...
      function h(g, F) {
        ...
        w && (w = t.normalize(w)),
          (D = D.map(String)
            .map(t.normalize)
            .map(function (_) {
              return w && t.isAbsolute(w) && t.isAbsolute(_)
                ? t.relative(w, _)
                : _;
            })),
        ...
        for (
          ...
          if (g.charAt(L) === ";") A++, L++, (C = 0);
            ...
            if (((P = g.slice(L, M)), (j = _[P]), j)) L += P.length;
              ...
              for (j = []; L < M; )
                s.decode(g, L, x), (V = x.value), (L = x.rest), j.push(V);
              if (j.length === 2)
...
`,
        ...
        function ui(i) {
          ...
          if (((a = i.toString()), i.source)) {
            ...
            for (
              c = l[1], a = "", T = !1, O = !1, d = 0, k = i.source.length;
              d < k;
              ++d
            )
        ...
        function Pr(i) {
          ...
          for (l = 0, a = i.length; l < a; ++l)
            (c = i[l]), (d += Array.isArray(c) ? Pr(c) : c);
          return d;
        }
        function Y(i, l) {
            ...
            return (
              ae(function () {
                l.left.type === t.VariableDeclaration
                  ...
                  (c = W(c, i)),
                  (c = [
                    W(c, d.generateExpression(l.right, r.Assignment, R)),
                    ")",
                  ]);
              }),
...
` && (d = ["{"]),
                  ...
                  var I, T, O, J;
                  for (
                    J = re, l & se && (J |= ue), I = 0, T = i.body.length;
                    I < T;
                    ++I
                  )
                    B &&
...
` && (d = ["{"])),
                        i.body[0].leadingComments ||
                          Xe(i.range[0], i.body[0].range[0], d)),
                      I > 0 &&
                      ...
                      B &&
                        ...
                        (i.body[I].trailingComments ||
                          Xe(i.body[I].range[1], i.range[1], d));
                }),
                d.push(fe("}")),
                d
              );
              ...
              return (
                ae(function () {
                  ...
                  i.param
                    ? ((a = [
                        "catch" + E + "(",
                        c.generateExpression(i.param, r.Sequence, R),
                        ")",
                      ]),
                      i.guard &&
                        ...
                        : i.specifiers[0].type === t.ExportBatchSpecifier
                          ...
                          : ((a = W(a, "{")),
                            ae(function (k) {
                              var I, T;
                              for (
                                a.push(D), I = 0, T = i.specifiers.length;
                                I < T;
                                ++I
                              )
                                a.push(k),
            ...
            ExpressionStatement: function (i, l) {
              ...
              function I(T) {
                ...
                if (
                  T.slice(0, 5) !== "async" ||
                  !u.code.isWhiteSpace(T.charCodeAt(5))
                )
                  return !1;
                for (
                  J = 6, ce = T.length;
                  J < ce && u.code.isWhiteSpace(T.charCodeAt(J));
                  ++J
                );
                      ...
                      : (a.push(E + "{"),
                        i.specifiers.length - c === 1
                          ...
                          : (ae(function (k) {
                              var I, T;
                              for (
                                a.push(D), I = c, T = i.specifiers.length;
                                I < T;
                                ++I
                              )
                                a.push(k),
...
`),
                  ...
                  for (
                    i.test
                      ? (a = [
                          W(
                            "case",
                            T.generateExpression(i.test, r.Sequence, R),
                          ),
                          ":",
                        ])
                      : (a = ["default:"]),
                      ...
                      k &&
                        ...
                        ((c = T.maybeBlock(i.consequent[0], re)),
                        a.push(c),
                        (d = 1)),
            ...
            IfStatement: function (i, l) {
              ...
              return (
                ae(function () {
                  a = [
                    "if" + E + "(",
                    k.generateExpression(i.test, r.Sequence, R),
                    ")",
                  ];
                }),
                (d = l & Z),
                  ...
                  (a = ["for" + E + "("]),
                    i.init
                      ? i.init.type === t.VariableDeclaration
                        ...
                        : (a.push(c.generateExpression(i.init, r.Sequence, st)),
                          a.push(";"))
                      : a.push(";"),
                    i.test &&
                      (a.push(E),
                      a.push(c.generateExpression(i.test, r.Sequence, R))),
                    a.push(";"),
                    i.update &&
                      (a.push(E),
                      a.push(c.generateExpression(i.update, r.Sequence, R))),
                    a.push(")");
                }),
            ...
            LabeledStatement: function (i, l) {
              return [
                i.label.name + ":",
                this.maybeBlock(i.body, l & Z ? xe : re),
              ];
            },
...
`
                ...
                !S && d === k - 1 && (I |= Z),
                  B &&
                    (d === 0 &&
                      (i.body[0].leadingComments ||
                        Xe(i.range[0], i.body[d].range[0], a)),
                    d > 0 &&
                  ...
                  B &&
                    ...
                    (i.body[d].trailingComments ||
                      Xe(i.body[d].range[1], i.range[1], a));
              return a;
            },
            ...
            WhileStatement: function (i, l) {
              ...
              return (
                ae(function () {
                  a = [
                    "while" + E + "(",
                    c.generateExpression(i.test, r.Sequence, R),
                    ")",
                  ];
                }),
                a.push(this.maybeBlock(i.body, l & Z ? xe : re)),
            ...
            WithStatement: function (i, l) {
              ...
              return (
                ae(function () {
                  a = [
                    "with" + E + "(",
                    c.generateExpression(i.object, r.Sequence, R),
                    ")",
                  ];
                }),
                a.push(this.maybeBlock(i.body, l & Z ? xe : re)),
          ...
          (oe.Expression = {
            ...
            MemberExpression: function (i, l, a) {
              ...
              return (
                (c = [
                  this.generateExpression(i.object, r.Call, a & H ? Re : Je),
                ]),
                i.computed
                  ? (i.optional && c.push("?."),
                    c.push("["),
                ...
                ? ((c = i.properties.length > 1),
                  ...
                  !c && !ii(Y(k).toString())
                    ...
                    : (ae(function (T) {
                        ...
                        if (((d = ["{", D, T, k]), c))
                          for (
                            d.push("," + D), O = 1, J = i.properties.length;
                            O < J;
                            ++O
                          )
                            d.push(T),
            ...
            ObjectPattern: function (i, l, a) {
              ...
              if (((I = !1), i.properties.length === 1))
                (T = i.properties[0]),
                  T.type === t.Property &&
                    T.value.type !== t.Identifier &&
                    (I = !0);
              else
                for (d = 0, k = i.properties.length; d < k; ++d)
                  if (
                    ((T = i.properties[d]),
                    T.type === t.Property && !T.shorthand)
                  ) {
                    I = !0;
                    break;
                  }
              return (
                ...
                ae(function (J) {
                  ...
                  for (ce = 0, Ve = i.properties.length; ce < Ve; ++ce)
                    c.push(I ? J : ""),
                      c.push(
                        O.generateExpression(i.properties[ce], r.Sequence, R),
                      ),
...
`,
        ...
        (z.parseFunction = function (e, t, r, n) {
          this.initFunction(e),
            ...
            t & Ye &&
              ((e.id =
                t & Zt && this.type !== f.name ? null : this.parseIdent()),
              e.id &&
                !(t & Pt) &&
                this.checkLVal(
                  e.id,
          ...
          return (
            ...
            this.finishNode(
              e,
              t & Ye ? "FunctionDeclaration" : "FunctionExpression",
            )
          );
        }),
...
`,
        ...
        (q.regexp_eatClassAtom = function (e) {
          ...
          if (e.eat(92)) {
            ...
            if (e.switchU) {
              var r = e.current();
              (r === 99 || Jr(r)) && e.raise("Invalid class escape"),
                e.raise("Invalid escape");
            }
            e.pos = t;
          }
  ...
  Jn = function (e, t, r, n) {
    ...
    if (
      (v.forEach(function (P) {
        var j = Zs(
            P,
            Object.keys(m).includes(P),
            m[P],
            Object.keys(F).includes(P),
            F[P],
            t,
            r,
            n,
