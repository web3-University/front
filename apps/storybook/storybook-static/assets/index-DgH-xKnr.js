        ...
        (function (o, i) {
          ...
          function J(e) {
            const t = (r, s, c) => {
              const y = r.lexer.current.type,
                T = r.lexer.next.type;
              if (c === null) {
                if ("parsePrefix" in e && e.accept(y, T))
            ...
            return J({
              ...
              parsePrefix: (r) => {
                ...
                if (r.consume("StringValue"))
                  ...
                  let k = "";
                  const x = ["Identifier", "@", "/"];
                  for (; x.some((S) => r.consume(S)); )
                    (k += y.text), (y = r.lexer.current);
                  c = {
                    type: "JsdocTypeSpecialNamePath",
                    value: k,
                    specialType: s,
                ...
                if (!r.consume("}")) {
                  ...
                  for (;;) {
                    ...
                    r.acceptLexerState(y),
                      T === void 0 &&
                        t &&
                        (T = r.parseIntermediateType(m.OBJECT));
                    let g = !1;
                    if (
            ...
            je = J({
              ...
              parsePrefix: (e) => (
                e.consume("typeof"),
                {
                  ...
                  element: e.parseType(m.KEY_OF_TYPE_OF),
                }
              ),
            }),
            Zt = [
          ...
          const rn = J({
              ...
              parsePrefix: (e) => (
                ...
                {
                  type: "JsdocTypeKeyof",
                  element: P(e.parseType(m.KEY_OF_TYPE_OF)),
                }
              ),
            }),
            an = J({
            ...
            yn = J({
              ...
              parsePrefix: (e) => (
                e.consume("readonly"),
                {
                  ...
                  element: Mt(e.parseIntermediateType(m.ALL)),
                }
              ),
            }),
            dn = J({
      ...
      case "union":
        return (p = n.elements) != null && p.every(In)
          ? {
              ...i,
              name: "enum",
              value: (u = n.elements) == null ? void 0 : u.map(Rn),
            }
          : {
              ...i,
              name: a,
        ...
        return (
          (p = n.elements) != null && p.every((v) => v.name === "literal")
            ? (h = {
                ...
                name: "enum",
                value:
                  (u = n.elements) == null ? void 0 : u.map((v) => Ye(v.value)),
              })
            : (h = {
                ...i,
                name: a,
                value: (d = n.elements) == null ? void 0 : d.map(G),
              }),
          h
        );
      case "intersection":
        return {
          ...i,
          name: a,
          value: (f = n.elements) == null ? void 0 : f.map(G),
        };
      default:
        return { ...i, name: "other", value: a };
    }
...
function tt({ fence: n = "```" } = {}) {
  ...
  return l(function (i) {
    let p = [[]],
      u = !1;
    for (let d of i)
      qn.test(d.tokens.description) && !u
        ? p.push([d])
        : p[p.length - 1].push(d),
