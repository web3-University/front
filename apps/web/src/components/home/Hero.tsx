...
export default function Hero() {
  ...
  const stats: StatItem[] = useMemo(
    () => [
      { value: "50,000+", label: t("hero.metrics.registeredUsers") },
      { value: "2,500+", label: t("hero.metrics.totalCourses") },
      { value: "Ƀ 1.2M", label: t("hero.metrics.tradingVolume") },
      { value: "15,000+", label: t("hero.metrics.nftCertificates") },
    ],
    [t],
  );
