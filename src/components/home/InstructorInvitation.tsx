...
export default function InstructorInvitation() {
  const t = useTranslations("home.instructorInvitation");

  const highlights: HighlightItem[] = [
    {
      icon: ShieldCheck,
      title: t("highlights.revenueShare.title"),
      description: t("highlights.revenueShare.description"),
  ...
  const stats = [
    { label: t("stats.instructors"), value: "127" },
    { label: t("stats.revenue"), value: "Ƀ 1.2M", highlight: true },
    { label: t("stats.rating"), value: "4.8" },
