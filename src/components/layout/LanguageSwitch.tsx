...
import { useLocaleSwitch } from "@/state/i18n/localeSwitch";

import { usePathname, useRouter } from "@/navigation";

export default function LanguageSwitch() {
  const { locale, nextLocale, labels, replaceLocale } = useLocaleSwitch();

  const handleToggle = () => replaceLocale();
  ...
  //   console.log(pathWithoutLocale,'__pathWITHOUT')
