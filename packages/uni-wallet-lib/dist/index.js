...
function h(e = {}) {
  const {
      domain: a = "undefined" != typeof window
        ? window.location.host
        : "localhost",
      apiBaseUrl: r = "/api/v1/auth",
      onSuccess: s,
      onError: o,
      onStatusChange: c,
    } = e,
    ...
    { signSIWEMessage: p } = (function () {
      const { address: e } = l(),
        ...
        o = (e, t, n, a = 1, r = "Sign in with Ethereum to the app.") =>
          new i.SiweMessage({
            domain: e,
            address: t,
            statement: r,
      ...
      return {
        ...
        signSIWEMessage: async (n, a, r) => {
          if (!e) throw new Error("❗️ 钱包未连接");
          const s = o(n, e, a, r),
            i = await t({ message: s.toMessage() });
          return { message: s, signature: i, address: e };
        },
        generateSIWEMessage: o,
      };
    })(),
    { address: h, isConnected: f } = l(),
    [g, b] = t.useState(y.IDLE),
    [w, x] = t.useState(null),
    v = t.useCallback(
      (e) => {
        b(e), c?.(e);
    ...
    C = t.useCallback(async () => {
      if (!h || !f) {
        ...
        return x(e.message), o?.(e), null;
      }
      x(null);
      try {
        v(y.REQUESTING_NONCE);
        const { nonce: e } = await (async (e) => {
          const t = await fetch(`${a}${r}/nonce`, {
            method: "POST",
        ...
        v(y.WAITING_SIGNATURE);
        const { signature: t, message: n } = await p(a, e);
        v(y.VERIFYING);
        const { accessToken: i, refreshToken: o } = await (async (e, t, n) => {
          const s = await fetch(`${a}${r}/login`, {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({
              walletAddress: e,
        ...
        const t = e instanceof Error ? e.message : "Authentication failed",
          n =
            ...
            t.toLowerCase().includes("user rejected")
              ...
              : t;
        return (
          x(n), v(y.ERROR), o?.(e instanceof Error ? e : new Error(n)), null
        );
      } finally {
        setTimeout(() => {
          N();
    ...
    T = t.useCallback(() => {
      m.removeItem(d),
        m.removeItem(u),
        m.removeItem(`${d}_address`),
        v(y.IDLE),
        x(null);
    }, [d, u, v]),
    k = t.useCallback(() => {
      const e = m.getItem(d),
        t = m.getItem(`${d}_address`);
      return !(!e || !t || t !== h);
    }, [d, h]),
    j = t.useCallback(() => {
      const e = m.getItem(`${d}_address`);
      e && h && e !== h && T();
    }, [h, d, T]),
    N = t.useCallback(() => {
      v(y.IDLE), x(null);
  ...
  return {
    status: g,
    isAuthenticated: k(),
    isAuthenticating: g !== y.IDLE && g !== y.SUCCESS && g !== y.ERROR,
    error: w,
    address: h,
    signIn: C,
    signOut: T,
...
function w({ children: n, autoSignOnConnect: a = !1, ...r }) {
  ...
  return e.jsxs(b.Provider, {
    value: w,
    children: [n, e.jsx(g, { status: u, error: y, onClose: d })],
  });
}
const x = new r.QueryClient({
  defaultOptions: { queries: { refetchOnWindowFocus: !1, retry: !1 } },
});
function v({ onNetworkChange: e, onAccountChange: a } = {}) {
  const r = n.useChainId(),
    { address: s } = n.useAccount();
  return (
    t.useEffect(() => {
      e && r && e(r);
    }, [r, e]),
    ...
    { currentChainId: r, currentAddress: s }
  );
}
function C({
  address: e,
...
const S = "0x5fbdb2315678afecb367f032d93f642f64180aa3";
f(
...
(exports.AuthModal = g),
  ...
  (exports.NetworkSync = function ({
    debug: t = !1,
    onNetworkChange: n,
    onAccountChange: a,
  }) {
    const { currentChainId: r, currentAddress: s } = v({
      onNetworkChange: (e) => {
        n?.(e);
      },
      onAccountChange: (e) => {
    ...
    return t
      ? e.jsxs("div", {
          ...
          children: [
            e.jsxs("div", { children: ["Chain: ", r] }),
            e.jsxs("div", { children: ["Account: ", s?.slice(0, 6), "..."] }),
          ],
        })
      : null;
  }),
  ...
  (exports.useSimpleYDToken = function ({
    ...
    const { address: s } = n.useAccount(),
      ...
      { data: g, refetch: b } = h.read("balanceOf", r && !!s)(s),
