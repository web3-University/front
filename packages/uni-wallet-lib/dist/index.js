...
function useWalletConnection() {
    const { address, connector, isConnected, isConnecting, isReconnecting } = wagmi.useAccount();
...
function useWalletSign() {
    ...
    const { signMessageAsync, isPending, isSuccess, isError } = wagmi.useSignMessage();
    /**
...
function AuthModal({ status, error, onClose }) {
    ...
    return /*#__PURE__*/ jsxRuntime.jsx("div", {
        ...
        children: /*#__PURE__*/ jsxRuntime.jsxs("div", {
            ...
            children: [
                status === SignInStatus.REQUESTING_NONCE && /*#__PURE__*/ jsxRuntime.jsxs("div", {
                ...
                status === SignInStatus.WAITING_SIGNATURE && /*#__PURE__*/ jsxRuntime.jsxs("div", {
                    className: "auth-modal-body",
                    children: [
                        /*#__PURE__*/ jsxRuntime.jsx("div", {
                ...
                status === SignInStatus.VERIFYING && /*#__PURE__*/ jsxRuntime.jsxs("div", {
                    className: "auth-modal-body",
                    children: [
                        /*#__PURE__*/ jsxRuntime.jsx("div", {
                            className: "auth-modal-spinner",
                ...
                status === SignInStatus.SUCCESS && /*#__PURE__*/ jsxRuntime.jsxs("div", {
                    className: "auth-modal-body",
                    children: [
                        /*#__PURE__*/ jsxRuntime.jsx("div", {
                ...
                status === SignInStatus.ERROR && /*#__PURE__*/ jsxRuntime.jsxs("div", {
                    className: "auth-modal-body",
                    children: [
                        /*#__PURE__*/ jsxRuntime.jsx("div", {
 ...
 */ function AuthProvider({ children, autoSignOnConnect = false, ...authConfig }) {
    ...
    return /*#__PURE__*/ jsxRuntime.jsxs(AuthContext.Provider, {
        ...
        children: [
            children,
            /*#__PURE__*/ jsxRuntime.jsx(AuthModal, {
                status: status,
                error: error,
                onClose: reset
            })
...
function WalletProvider({ children, theme = "auto", queryClient = defaultQueryClient, initialState, enableAuth = false, authConfig, ...configOptions }) {
    ...
    const content = enableAuth && authConfig ? /*#__PURE__*/ jsxRuntime.jsx(AuthProvider, {
        ...authConfig,
        children: children
    }) : children;
...
function useNetworkSwitch() {
    ...
    const { switchChain, isPending, error, isSuccess, reset } = wagmi.useSwitchChain();
...
function useContractWrite({ address, abi, functionName, args, value, chainId, enabled = true, gasLimit }) {
    const { writeContract, writeContractAsync, ...returnTypes } = wagmi.useWriteContract();
...
function useSimpleYDToken({ address = YD_CONTRACT_ADDRESS, spenderAddress, enabled = true }) {
    ...
    const { data: gasEstimate, refetch: refetchEstimateGas } = wagmi.useEstimateGas({
        account: userAddress,
        to: estGasTo,
        value: estGasValue,
        query: {
   ...
   */ const exchangeETHForTokens = async (ether)=>{
        await prepareRefetchEstimateGas(YD_CONTRACT_ADDRESS, viem.parseEther(ether));
...
const WalletButton = ({ label = "连接钱包", showBalance = true, showChainName = true, className = "", size = "medium" })=>{
    ...
    // 格式化YD币余额显示
    const ydBalanceLabel = React.useMemo(()=>{
        console.log("一灯币", totalSupply);
        if (!ydBalance) return "0";
        return Number(viem.formatUnits(ydBalance, 18)).toFixed(4);
    }, [
        ydBalance
    ]);
    return /*#__PURE__*/ jsxRuntime.jsx("div", {
                ...
                return /*#__PURE__*/ jsxRuntime.jsx("div", {
                    ...
                    children: (()=>{
                        ...
                        return /*#__PURE__*/ jsxRuntime.jsxs("div", {
                            ...
                            children: [
                                showChainName && /*#__PURE__*/ jsxRuntime.jsxs("div", {
                                    className: "wallet-button__chain",
                                    children: [
                                        currentChain.iconUrl && /*#__PURE__*/ jsxRuntime.jsx("div", {
                                        ...
                                        showBalance && /*#__PURE__*/ jsxRuntime.jsxs("span", {
                                            children: [
                                                ydBalanceLabel,
                                                " YD"
                                            ]
...
exports.NetworkSync = NetworkSync;
...
exports.useWalletSign = useWalletSign;
exports.useWatchNetwork = useWatchNetwork;
